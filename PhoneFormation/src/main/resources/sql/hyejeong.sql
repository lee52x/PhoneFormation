...
insert into spec_display values (19,'4.7형(대각선) LED 백라이트 와이드스크린','1334 x 750 픽셀 해상도(326ppi)','Retina HD 디스플레이, Multi-Touch 디스플레이(IPS 기술), 와이드 컬러 디스플레이(P3), 625 cd/m2 최대 밝기(일반), 광시야각을 위한 듀얼 도메인 픽셀, 지문 및 유분 방지 코팅', '1400:1 명암비(일반)', 'null');
insert into spec_display values (20,'5.5형(대각선) LED 백라이트 와이드스크린','1920 x 1080 픽셀 해상도(401ppi)','Retina HD 디스플레이, Multi-Touch 디스플레이(IPS 기술), 와이드 컬러 디스플레이(P3), 625 cd/m2 최대 밝기(일반), 광시야각을 위한 듀얼 도메인 픽셀, 지문 및 유분 방지 코팅', '1300:1 명암비(일반)', 'null');
insert into spec_display values (21,'4.7형(대각선) LED 백라이트 와이드스크린','1334 x 750 픽셀 해상도(326ppi)','3D Touch가 적용된 Retina HD 디스플레이, 500 cd/m2 최대 밝기(일반), 풀 sRGB표준, 광시야각을 위한 듀얼 도메인 픽셀, 지문 및 유분 방지 코팅', '1400:1 명암비(일반)', 'null');
insert into spec_display values (22,'5.5형(대각선) LED 백라이트 와이드스크린','1920 x 1080 픽셀 해상도(401ppi)','3D Touch가 적용된 Retina HD 디스플레이, 500 cd/m2 최대 밝기(일반), 풀 sRGB표준, 광시야각을 위한 듀얼 도메인 픽셀, 지문 및 유분 방지 코팅', '1300:1 명암비(일반)', 'null');
insert into spec_display values (23,'5.5형(대각선) LED 백라이트 와이드스크린','1920 x 1080 픽셀 해상도(401ppi)','Retina HD 디스플레이, 500 cd/m2 최대 밝기(일반), 풀 sRGB표준, 광시야각을 위한 듀얼 도메인 픽셀, 지문 및 유분 방지 코팅', '1300:1 명암비(일반)', 'null');
insert into spec_display values (24,'4형(대각선) LED 백라이트 와이드스크린 Multi-Touch 디스플레이','1136 x 640 픽셀 해상도(326ppi)','Retina HD 디스플레이, 500 cd/m2 최대 밝기(일반), 풀 sRGB표준, 지문 및 유분 방지 코팅', '800:1 명암비(일반)', 'null');
insert into spec_display values (25,'152.3mm','2560 X 1440 QHD IPS 퀀텀','null', 'null', 'null');
insert into spec_display values (26,'152.3mm','2560 X 1440 QHD IPS 퀀텀','null', 'null', 'null');
insert into spec_display values (27,'134.6mm','2560 X 1440 QHD IPS 퀀텀','null', 'null', 'null');
insert into spec_display values (28,'138.8mm','2560 X 1440','null', 'null', 'null');
insert into spec_display values (29,'144.7mm','HD IPS 디스플레이(258ppi)','null', 'null', 'null');
insert into spec_display values (30,'138.7mm','1920 X 1080 (Full HD)','null', 'null', 'null');
insert into spec_display values (31,'152mm','Full HD IPS LCD','null', 'null', 'null');
insert into spec_display values (32,'132.2mm','1920 X 1080 (Full HD IPS 디스플레이)','null', 'null', 'null');
insert into spec_display values (33,'138.78mm','2560x1440 (Quad HD IPS 디스플레이)','null', 'null', 'null');
...
insert into spec_camera values (1,'UHD 4K (3840 x 2160) @30fps','Dual Pixel 12.0 MP','f/1.7','CMOS 5.0 MP','f/1.7','예', '예', 'null');
insert into spec_camera values (2,'UHD 4K (3840 x 2160) @30fps','Dual Pixel 12.0 MP','f/1.7','CMOS 5.0 MP','f/1.7','예', '예', 'null');
insert into spec_camera values (3,'UHD 4K (3840 x 2160) @30fps','Dual Pixel 12.0 MP','f/1.7','CMOS 5.0 MP','f/1.7','예', '예', 'null');
insert into spec_camera values (4,'UHD 4K (3840 x 2160) @30fps','Dual Pixel 12.0 MP','f/1.7','CMOS 5.0 MP','f/1.7','예', '예', 'null');
insert into spec_camera values (5,'UHD 4K (3840 x 2160) @30fps','CMOS 16.0 MP','null','CMOS 5.0 MP','null','예', '예', 'null');
insert into spec_camera values (6,'UHD 4K (3840 x 2160) @30fps','CMOS 16.0 MP','null','CMOS 5.0 MP','null','예', '예', 'null');
insert into spec_camera values (7,'UHD 4K (3840 x 2160) @30fps','CMOS 16.0 MP','null','CMOS 5.0 MP','null','예', '예', 'null');
insert into spec_camera values (8,'UHD 4K (3840 x 2160) @30fps','CMOS 16.0 MP','null','CMOS 5.0 MP','null','예', '예', 'null');
insert into spec_camera values (9,'FHD 4K (1920 x 1080) @30fps','CMOS 16.0 MP','f/1.9','CMOS 8.0 MP','f/1.9','예', '예', 'null');
insert into spec_camera values (10,'FHD (1920 x 1080) @30fps','CMOS 13.0 MP','f/1.9','CMOS 5.0 MP','f/1.9','예', '예', 'null');
insert into spec_camera values (11,'FHD (1920 x 1080) @30fps','CMOS 13.0 MP','f/1.9','CMOS 5.0 MP','f/1.9','예', '예', 'null');
insert into spec_camera values (12,'FHD (1920 x 1080) @30fps','CMOS 13.0 MP','f/1.9','CMOS 5.0 MP','f/1.9','예', '예', 'null');
insert into spec_camera values (13,'FHD (1920 x 1080) @30fps','CMOS 13.0 MP','null','CMOS 5.0 MP','null','예', '예', 'null');
insert into spec_camera values (14,'FHD (1920 x 1080) @30fps','CMOS 13.0 MP','f/1.9','CMOS 5.0 MP','f/1.9','예', '예', 'null');
insert into spec_camera values (15,'FHD (1920 x 1080) @30fps','CMOS 13.0 MP','f/1.9','CMOS 5.0 MP','f/1.9','예', '예', 'null');
insert into spec_camera values (16,'UHD 4K (3840 x 2160)@30fps','CMOS 16.0 MP','null','CMOS 3.7 MP','null','예', '예', 'null');
insert into spec_camera values (17,'UHD 4K (3840 x 2160)@30fps','CMOS 16.0 MP','null','CMOS 3.7 MP','null','예', '예', 'null');
insert into spec_camera values (18,'UHD 4K (3840 x 2160)@30fps','CMOS 16.0 MP','null','CMOS 3.7 MP','null','예', '예', 'null');
insert into spec_camera values (19,'null','1200만 화소 카메라','f/1.8','null','null','null', 'null','디지털 줌 최대 5배<br> 광학 이미지 흔들림 보정(OIS)<br> 6매(Six-element) 렌즈<br>
...
insert into spec_camera values (20,'null','1200만 화소 와이드 앵글 및 망원 카메라','와이드 앵글: f/1.8 ,조리개망원: f/2.8 조리개','null','null','null', 'null','광학 줌 2배, 디지털 줌 최대 10배<br> 
...
insert into spec_camera values (21,'null','1200만 화소 카메라','f/2.2 조리개','null','null','null', 'null','이미지 흔들림 보정을 갖춘 Live Photos<br> Focus Pixels를 갖춘 오토포커스<br> 
...
insert into spec_camera values (22,'null','1200만 화소 카메라','f/2.2 조리개','null','null','null', 'null','이미지 흔들림 보정을 갖춘 Live Photos<br> Focus Pixels를 갖춘 오토포커스<br> 
...
insert into spec_camera values (23,'null','1200만 화소 카메라','f/2.2 조리개','null','null','null', 'null','이미지 흔들림 보정을 갖춘 Live Photos<br> Focus Pixels를 갖춘 오토포커스<br> 
광학 이미지 흔들림 보정(iPhone 6s Plus만 해당)<br> True Tone 플래시<br> 파노라마(최대 6300만 화소)<br> 사진을 위한 자동 HDR<br> 노출 조절<br> 고속 연사 모드<br> 타이머 모드<br> 5매(Five-element) 렌즈<br> 
5배 디지털 줌<br> 하이브리드 IR 필터<br> 후면 조명 센서<br> 사파이어 크리스털 렌즈 커버<br> 자동 흔들림 보정<br> 주변 색조 매핑<br> 노이즈 감소<br> 얼굴 인식<br> 사진 위치 표시 기능');
insert into spec_camera values (24,'null','1200만 화소 카메라','f/2.2 조리개','null','null','null', 'null','이미지 흔들림 보정을 갖춘 Live Photos<br> Focus Pixels를 갖춘 오토포커스<br> 
...
5배 디지털 줌<br> 하이브리드 IR 필터<br> 후면 조명 센서<br> 사파이어 크리스털 렌즈 커버<br> 자동 흔들림 보정<br> 주변 색조 매핑<br> 노이즈 감소<br> 얼굴 인식<br> 사진 위치 표시 기능');
insert into spec_camera values (25,'null','일반 : 1600만화소 / 광각 : 800만화소','null','광각 500만화소','null','예', '예', 'null');
insert into spec_camera values (26,'null','1600만화소','null','듀얼 500만화소','null','예', '예', 'null');
insert into spec_camera values (27,'null','일반 : 1600만화소 / 광각 : 800만화소','null','광각 800만화소','null','예', '예', 'null');
insert into spec_camera values (28,'null','1600만화소','null','800만화소','null','예', '예', 'null');
insert into spec_camera values (29,'null','800만화소','null','500만화소','null','예', '예', 'null');
insert into spec_camera values (30,'null','1300만화소','null','210만화소','null','예', '예', 'null');
insert into spec_camera values (31,'null','1300만화소','null','210만화소','null','예', '예', 'null');
insert into spec_camera values (32,'null','1300만화소','null','210만화소','null','예', '예', 'null');
insert into spec_camera values (33,'null','1300만화소','null','210만화소','null','예', '예', 'null');
insert into spec_camera values (34,'null','1300만화소','null','210만화소','null','예', '예', 'null');
...
insert into spec_memory values (5,'4GB','64GB','53.8GB','null');
insert into spec_memory values (6,'4GB','32GB','24.2GB','null');
...
insert into spec_memory values (25,'4GB','64GB','null','MicroSD slot 지원');
insert into spec_memory values (26,'4GB','64GB','null','MicroSD slot 지원');
insert into spec_memory values (27,'4GB','32GB','null','MicroSD slot 지원');
insert into spec_memory values (28,'3GB','32GB','null','MicroSD slot 지원');
insert into spec_memory values (29,'1.5GB','8GB','null','MicroSD slot 지원');
insert into spec_memory values (30,'2GB','32GB','null','MicroSD slot 지원');
insert into spec_memory values (31,'2GB','32GB','null','MicroSD slot 지원');
insert into spec_memory values (32,'2GB','32GB','null','MicroSD slot 지원');
insert into spec_memory values (33,'3GB','32GB','null','MicroSD slot 지원');
insert into spec_memory values (34,'3GB','32GB','null','MicroSD slot 지원');
...
insert into spec_network values (5,'null','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B2(1900), B3(1800), B5(850), B7(2600), B8(900), B17(700), B20(800), B26(800)','B38(2600), B39(1900), B41(2500)');
insert into spec_network values (6,'null','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B2(1900), B3(1800), B5(850), B7(2600), B8(900), B17(700), B20(800), B26(800)','B38(2600), B39(1900), B41(2500)');
insert into spec_network values (7,'Nano-SIM (4FF)','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B2(1900), B3(1800), B5(850), B7(2600), B8(900), B17(700), B20(800), B26(800)','null');
insert into spec_network values (8,'Nano-SIM (4FF)','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B2(1900), B3(1800), B5(850), B7(2600), B8(900), B17(700), B20(800), B26(800)','null');
insert into spec_network values (9,'SIM 1 + MicroSD','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B3(1800), B5(850), B7(2600), B8(900), B17(700), B28(700)','B38(2600)');
insert into spec_network values (10,'SIM 1 + MicroSD','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B3(1800), B5(850), B7(2600), B8(900), B17(700)','null');
insert into spec_network values (11,'null','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B3(1800), B5(850), B7(2600), B8(900), B17(700)','null');
insert into spec_network values (12,'null','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B3(1800), B5(850), B7(2600), B8(900), B17(700)','null');
insert into spec_network values (13,'null','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B3(1800), B5(850), B7(2600), B8(900)','null');
insert into spec_network values (14,'SIM 1','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B3(1800), B5(850), B7(2600), B8(900), B17(700)','null');
insert into spec_network values (15,'SIM 1','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B3(1800), B5(850), B7(2600), B8(900), B17(700)','null');
insert into spec_network values (16,'Micro-SIM (3FF)','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B3(1800), B5(850), B7(2600), B8(900), B17(700)','null');
insert into spec_network values (17,'Micro-SIM (3FF)','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B3(1800), B5(850), B7(2600), B8(900), B17(700)','null');
insert into spec_network values (18,'Micro-SIM (3FF)','GSM900, DCS1800, PCS1900','B1(2100), B2(1900), B5(850)','null','B1(2100), B3(1800), B5(850), B7(2600), B8(900), B17(700)','null');
...
insert into spec_connect values (19,'null','null','A-GPS(Assisted GPS), GLONASS, iBeacon 위치 정밀 감지 기능','null','null','MIMO 방식의 802.11a/b/g/n/ac Wi-Fi ','예','Bluetooth v4.2','예','null','null');
insert into spec_connect values (20,'null','null','A-GPS(Assisted GPS), GLONASS, iBeacon 위치 정밀 감지 기능','null','null','MIMO 방식의 802.11a/b/g/n/ac Wi-Fi ','예','Bluetooth v4.2','예','null','null');
insert into spec_connect values (21,'null','null','A-GPS(Assisted GPS), GLONASS, iBeacon 위치 정밀 감지 기능','null','null','MIMO 방식의 802.11a/b/g/n/ac Wi-Fi ','예','Bluetooth v4.2','예','null','null');
insert into spec_connect values (22,'null','null','A-GPS(Assisted GPS), GLONASS, iBeacon 위치 정밀 감지 기능','null','null','MIMO 방식의 802.11a/b/g/n/ac Wi-Fi ','예','Bluetooth v4.2','예','null','null');
insert into spec_connect values (23,'null','null','A-GPS(Assisted GPS), GLONASS, iBeacon 위치 정밀 감지 기능','null','null','MIMO 방식의 802.11a/b/g/n/ac Wi-Fi ','예','Bluetooth v4.2','예','null','null');
insert into spec_connect values (24,'null','null','A-GPS(Assisted GPS), GLONASS, iBeacon 위치 정밀 감지 기능','null','null','MIMO 방식의 802.11a/b/g/n/ac Wi-Fi ','예','Bluetooth v4.2','예','null','null');
insert into spec_connect values (25,'null','null','예','null','null','null','예','예','예','null','null');
insert into spec_connect values (26,'null','null','예','null','null','null','예','예','예','null','null');
insert into spec_connect values (27,'null','null','예','null','null','null','예','예','예','null','null');
insert into spec_connect values (28,'null','null','예','null','null','null','예','예','예','null','null');
insert into spec_connect values (29,'null','null','예','null','null','null','예','예','예','null','null');
insert into spec_connect values (30,'null','null','예','null','null','null','예','예','예','null','null');
insert into spec_connect values (31,'null','null','예','null','null','null','예','예','예','null','null');
insert into spec_connect values (32,'null','null','예','null','null','null','예','예','예','null','null');
insert into spec_connect values (33,'null','null','예','null','null','null','예','예','예','null','null');
...
insert into spec_specifications values (25,'Android', '티탄, 실버, 핑크','터치 정전식','159.7 x 78.61 x 7.6','173','null');
insert into spec_specifications values (26,'Android', '럭스 화이트, 모던 베이지, 오션 블루','터치 정전식','159.6 x 79.3 x 8.6','192','null');
insert into spec_specifications values (27,'Android', '실버, 티탄, 골드, 핑크','터치 정전식','149.4 x 73.9 x 7.7','159','null');
insert into spec_specifications values (28,'Android', '세라믹 화이트, 메탈릭 그레이, 천연 가죽 브라운, 천연 가죽 블랙','터치 정전식','148.9 x 76.1 x 9.8','155','null');
insert into spec_specifications values (29,'Android', '화이트, 티탄','터치 정전식','154.3 x 79.2 x 9.6','163','null');
insert into spec_specifications values (30,'Android', '플래티넘 실버, 플라멩고 레드','터치 정전식','149.1 x 75.3 x 7.1~9.4','152','null');
insert into spec_specifications values (31,'Android', '화이트, 블랙','터치 정전식','157.8 x 81.8 x 9.45','182','null');
insert into spec_specifications values (32,'Android', '티탄, 화이트','터치 정전식','141 x 71.6 x 9.8','146.8','null');
insert into spec_specifications values (33,'Android', '티탄, 화이트','터치 정전식','146.3 x 74.6 x 9.1','154','null');
insert into spec_specifications values (34,'Android', '메탈릭 블랙, 실크 화이트, 샤인 골드','터치 정전식','146.3 x 74.6 x 8.95','151','null');
...
insert into spec_battery values (5,'최대10','최대11','최대13','최대15','3000','아니오','최대64','null','최대22');
insert into spec_battery values (6,'최대10','최대11','최대12','최대15','3000','아니오','최대66','null','최대20');
insert into spec_battery values (7,'최대10','최대11','최대12','최대13','2600','아니오','최대50','null','최대18');
insert into spec_battery values (8,'최대10','최대11','최대12','최대13','2550','아니오','최대49','null','최대17');
insert into spec_battery values (9,'최대11','최대13','최대14','최대17','3300','아니오','최대44','최대60','최대22');
insert into spec_battery values (10,'최대12','최대13','최대15','최대14','2300','아니오','최대58','null','최대15');
insert into spec_battery values (11,'최대14','최대14','최대16','최대14','2900','아니오','최대75','null','최대18');
insert into spec_battery values (12,'최대14','최대14','최대17','최대15','3300','아니오','최대78','null','최대19');
insert into spec_battery values (13,'최대9','최대10','최대12','최대14','2600','null','최대62','null','최대19');
insert into spec_battery values (14,'최대11','최대12','최대14','최대16','3100','예','최대75','null','최대21');
insert into spec_battery values (15,'최대9','최대12','최대14','최대20','3300','예','최대86','null','최대24');
insert into spec_battery values (16,'최대9','최대10','최대11','최대21','3000','예','최대11','null','최대18');
insert into spec_battery values (17,'최대10','최대11','최대12','최대12','3220','예','최대53','null','최대20');
insert into spec_battery values (18,'최대10','최대11','최대12','최대12','3220','예','최대53','null','최대19');
insert into spec_battery values (19,'최대12','최대12','최대14','최대13','null','null','최대40','null','최대14');
insert into spec_battery values (20,'최대13','최대13','최대15','최대14','null','null','최대60','null','최대21');
insert into spec_battery values (21,'최대10','최대10','최대11','최대11','null','null','최대50','null','최대14');
insert into spec_battery values (22,'최대12','최대12','최대12','최대14','null','null','최대80','null','최대24');
insert into spec_battery values (23,'최대12','최대12','최대12','최대14','null','null','최대80','null','최대24');
insert into spec_battery values (24,'최대12','최대13','최대13','최대13','null','null','최대50','null','최대14');
insert into spec_battery values (25,'null','null','null','null','3200','null','null','null','최대16');
insert into spec_battery values (26,'null','null','null','null','3000','null','null','null','최대14');
insert into spec_battery values (27,'null','null','null','null','2800','null','null','null','최대14');
insert into spec_battery values (28,'null','null','null','null','3000','null','null','null','최대14');
insert into spec_battery values (29,'null','null','null','null','3000','null','null','null','최대13');
insert into spec_battery values (30,'null','null','null','null','3000','null','null','null','최대13');
insert into spec_battery values (31,'null','null','null','null','3000 X 2(착탈식)','null','null','null','최대13');
insert into spec_battery values (32,'null','null','null','null','2610 (착탈식)','null','null','null','최대12');
insert into spec_battery values (33,'null','null','null','null','3000 (착탈식)','null','null','null','최대17');
insert into spec_battery values (34,'null','null','null','null','3000 (착탈식)','null','null','null','최대17');
...
insert into spec_audio values (1,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','UHD 4K (3840 x 2160) @60fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (2,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','UHD 4K (3840 x 2160) @60fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (3,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','UHD 4K (3840 x 2160) @60fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (4,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','UHD 4K (3840 x 2160) @60fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (5,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','UHD 4K (3840 x 2160) @30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (6,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','UHD 4K (3840 x 2160) @30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (7,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','UHD 4K (3840 x 2160) @30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (8,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','UHD 4K (3840 x 2160) @30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (9,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','UHD 4K (3840 x 2160) @30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (10,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','FHD (1920 x 1080) @30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (11,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','FHD (1920 x 1080) @30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (12,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','FHD (1920 x 1080) @30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (13,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','FHD (1920 x 1080) @30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (14,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','FHD (1920 x 1080) @30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (15,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','FHD (1920 x 1080) @30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (16,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','UHD 4K (3840 x 2160)@30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (17,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','UHD 4K (3840 x 2160)@30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
insert into spec_audio values (18,'MP4, M4V, 3GP, 3G2, WMV, ASF, AVI, FLV, MKV, WEBM','UHD 4K (3840 x 2160)@30fps','MP3, M4A, 3GA, AAC, OGG, OGA, WAV, WMA, AMR, AWB, FLAC, MID, MIDI, XMF, MXMF, IMY, RTTTL, RTX, OTA','null','null');
...
최대 35Mbps의 Motion JPEG(M-JPEG), 1280 x 720 픽셀, 초당 30프레임, ulaw 오디오, .avi 파일 포맷 PCM 스테레오 오디오','null','지원되는 오디오 포맷: AAC(8~320Kbps), 복사 방지된 AAC(iTunes Store), HE-AAC, MP3(8~320Kbps), MP3 VBR, Dolby Digital(AC-3), 
...
insert into spec_service values (1,'기어 서클(매니저 서포트), 기어 핏, 기어1, 기어2, 기어2 네오, 기어 S, 기어 S2, 기어 VR','예','예','null','null');
insert into spec_service values (2,'기어 서클(매니저 서포트), 기어 핏, 기어1, 기어2, 기어2 네오, 기어 S, 기어 S2, 기어 VR','예','예','null','null');
insert into spec_service values (3,'기어 서클(매니저 서포트), 기어 핏, 기어1, 기어2, 기어2 네오, 기어 S, 기어 S2, 기어 VR','예','예','null','null');
insert into spec_service values (4,'기어 서클(매니저 서포트), 기어 핏, 기어1, 기어2, 기어2 네오, 기어 S, 기어 S2, 기어 VR','예','예','null','null');
insert into spec_service values (5,'기어 서클(매니저 서포트), 기어 핏, 기어','예','예','null','null');
insert into spec_service values (6,'기어 서클(매니저 서포트), 기어 핏, 기어','예','예','null','null');
insert into spec_service values (7,'기어 서클(매니저 서포트), 기어 핏, 기어','예','예','null','null');
insert into spec_service values (8,'기어 서클(매니저 서포트), 기어 핏, 기어','예','예','null','null');
insert into spec_service values (9,'기어 서클(매니저 서포트), 기어 핏, 기어 핏2, 기어S2','예','예','null','null');
insert into spec_service values (10,'null','예','아니오','null','null');
insert into spec_service values (11,'기어 서클(매니저 서포트), 기어 핏, 기어','예','예','null','null');
insert into spec_service values (12,'기어 서클(매니저 서포트), 기어 핏, 기어','예','예','null','null');
insert into spec_service values (13,'기어 서클(매니저 서포트), 기어S2','아니요','아니요','null','null');
insert into spec_service values (14,'기어 서클(매니저 서포트), 기어S2','아니요','예','null','null');
insert into spec_service values (15,'기어 서클(매니저 서포트), 기어S2','아니요','예','null','null');
insert into spec_service values (16,'기어 서클(매니저 서포트), 기어 핏 매니저, 기어 매니저','예','예','null','null');
insert into spec_service values (17,'기어 서클(매니저 서포트), 기어 핏 매니저, 기어 매니저, 기어 VR','예','예','null','null');
insert into spec_service values (18,'기어 서클(매니저 서포트), 기어 핏 매니저, 기어 매니저, 기어 VR','예','예','null','null');
insert into spec_service values (19,'null','null','null','음성으로 메시지 전송, 미리 알림 설정 외 다양한 기능 실행 가능<br> 능동적인 제안 기능<br> 핸즈프리 사용<br> 노래 듣고 제목 알려주기','IEC 규격 60529 하의 IP67 등급 획득');
insert into spec_service values (20,'null','null','null','음성으로 메시지 전송, 미리 알림 설정 외 다양한 기능 실행 가능<br> 능동적인 제안 기능<br> 핸즈프리 사용<br> 노래 듣고 제목 알려주기','IEC 규격 60529 하의 IP67 등급 획득');
insert into spec_service values (21,'null','null','null','음성으로 메시지 전송, 미리 알림 설정 외 다양한 기능 실행 가능<br> 능동적인 제안 기능<br> 핸즈프리 사용<br> 노래 듣고 제목 알려주기','null');
insert into spec_service values (22,'null','null','null','음성으로 메시지 전송, 미리 알림 설정 외 다양한 기능 실행 가능<br> 능동적인 제안 기능<br> 핸즈프리 사용<br> 노래 듣고 제목 알려주기','null');
insert into spec_service values (23,'null','null','null','음성으로 메시지 전송, 미리 알림 설정 외 다양한 기능 실행 가능<br> 능동적인 제안 기능<br> 핸즈프리 사용<br> 노래 듣고 제목 알려주기','null');
insert into spec_service values (24,'null','null','null','음성으로 메시지 전송, 미리 알림 설정 외 다양한 기능 실행 가능<br> 능동적인 제안 기능<br> 핸즈프리 사용<br> 노래 듣고 제목 알려주기','null');
insert into spec_service values (25,'null','null','예','null','null');
insert into spec_service values (26,'null','null','예','null','null');
insert into spec_service values (27,'null','null','예','null','null');
insert into spec_service values (28,'null','null','예','null','null');
insert into spec_service values (29,'null','null','예','null','null');
insert into spec_service values (30,'null','null','예','null','null');
insert into spec_service values (31,'null','null','예','null','null');
