											...
											<table>
												...
												<tr>
													...
													<tr>
														<td colspan="2" class="tLine"><hr>
															<div></div></td>
																									...
																									<tr>
														<th><h3>사업자등록번호</h3></th>
														<td><h3><input type="text" name="tel2" id="tel2"
																	maxlength="4" title="휴대폰 번호" style="width: 100px;">
															 - <input type="text" name="tel2" id="tel2"
																...
																- <input type="text" name="tel3" id="tel3" maxlength="4"
																	class="tBox tPhone" title="휴대폰 번호"
																	style="width: 100px;">
															<button class="btn btn-default btn-lg"><small><font style="font-weight: bold;">인증</font></small></button>		
															</h3>
													...
													<p class="busi_txt" style="color: #79ABFF;">
                                          			   ※ 사업자등록번호 도용 방지를 위해 기업인증을 시행하고 있습니다.<br>
                                            		   ※ 지점·지사의 경우, 해당 지점·지사의 사업자등록번호를 입력해 주세요.<br>
                                            		   ※ 인증이 되지 않을 경우 고객센터(T.1588-9351)로 문의해 주세요.
                                        			</p>
													</td>
													</tr>
													<tr>
